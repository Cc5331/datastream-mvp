...
- [ ] `cd frontend; node --test test/*.test.js` → **49** 个用例 0 失败（控件注册表一致性、按钮图标、数据源 CRUD、账户资料与在线状态、参数类型转换、模板与 AI 示例、端点权限入口隐藏、资源生命周期、拖拽落点幂等、参数持久化）。
